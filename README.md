...
LLMs are trained to interact as humans do, but do they think like humans as well? More specifically, can an LLM reveal through behavior the same thinking underpinning human semantic maps? 
